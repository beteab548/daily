        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-gray-600 leading-relaxed">
              ...
              prices. And Our Vision is To become our customers' most trusted and
              preferred place for buying quality products, known for great
        ...
        >
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We offer a wide variety of fresh and high-quality products to meet all your daily needs
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <h4 className="text-xl font-semibold text-gray-800">Fresh Produce</h4>
              </div>
              <p className="text-gray-600">Seasonal fruits and vegetables, locally sourced for maximum freshness and flavor.</p>
            </motion.div>
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <h4 className="text-xl font-semibold text-gray-800">Meat Products</h4>
              </div>
              <p className="text-gray-600">Premium quality beef, veal, lamb, and mutton, carefully selected and properly stored.</p>
            </motion.div>
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <h4 className="text-xl font-semibold text-gray-800">Poultry & Seafood</h4>
              </div>
              <p className="text-gray-600">Fresh chicken, turkey, and a selection of seafood delivered regularly.</p>
            </motion.div>
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <h4 className="text-xl font-semibold text-gray-800">Grocery Items</h4>
              </div>
              <p className="text-gray-600">Wide selection of both local and imported pantry staples and specialty items.</p>
            </motion.div>
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <h4 className="text-xl font-semibold text-gray-800">Bakery Products</h4>
              </div>
              <p className="text-gray-600">Freshly baked bread, pastries, and desserts made daily with quality ingredients.</p>
            </motion.div>
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <h4 className="text-xl font-semibold text-gray-800">Beverages</h4>
              </div>
              <p className="text-gray-600">Variety of non-alcoholic drinks including juices, sodas, waters, and specialty beverages.</p>
            </motion.div>
          </div>
        </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 border-l-4 border-amber-500">
                <div className="flex items-center mb-4">
                  ...
                  <h4 className="text-lg font-semibold text-gray-800">Bulk Orders</h4>
                </div>
                <p className="text-gray-600">For events and offices with special pricing and delivery options.</p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 border-l-4 border-blue-500">
                <div className="flex items-center mb-4">
                  ...
                  <h4 className="text-lg font-semibold text-gray-800">Weekly Deals</h4>
                </div>
                <p className="text-gray-600">Discounts and combo offers updated weekly for maximum savings.</p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 border-l-4 border-purple-500">
                <div className="flex items-center mb-4">
                  ...
                  <h4 className="text-lg font-semibold text-gray-800">Loyalty Program</h4>
                </div>
                <p className="text-gray-600">Earn points with every purchase and redeem them for exciting rewards.</p>
              </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 border-l-4 border-emerald-500">
                <div className="flex items-center mb-4">
                  ...
                  <h4 className="text-lg font-semibold text-gray-800">Gift Baskets</h4>
                </div>
                <p className="text-gray-600">Custom arrangements for holidays and special occasions, made to order.</p>
              </div>
            </div>
          </div>
        </motion.div>
