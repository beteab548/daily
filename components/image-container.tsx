...
function ImageContainers() {
  return (
    <div className="flex sm:-mt-0 -mt-95 mb-12 flex-wrap gap-4 mx-auto justify-center">
      {/* Image Card 1 */}
      <div className="flex flex-col md:flex-row relative shadow-2xl items-center group p-4 lg:w-150 w-full bg-white">
