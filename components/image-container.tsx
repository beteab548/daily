...
function ImageContainers() {
  return (
    <div className="flex flex-wrap gap-8 mx-auto justify-center p-4">
      {/* Image Card 1 */}
      <div className="flex flex-col md:flex-row relative shadow-2xl items-center p-4  group lg:w-150 w-full dark:bg-gray-800">
      ...
      {/* Image Card 2 */}
      <div className="flex flex-col md:flex-row relative shadow-2xl items-center p-4 bg-white group w-full  lg:w-150 dark:bg-gray-800">
        <div className="flex flex-col">
          <h1 className="text-center md:text-left w-full">
